      ...
      try {
        const response = await fetch("http://localhost:8003/auth/login", {
          ...
          body: JSON.stringify({
            ...
            org_id: parseInt(formData.orgId, 10),
        ...
        // Example: backend returns { "access_token": "..." }
    ...
    <div style={container}>
      ...
      >
          ...
          {["userId", "orgId", "password"].map((field) => (
            <div key={field} style={{ marginBottom: "1rem" }}>
              <input
                ...
                style={{
                  ...inputField,
                  border: errors[field] && "1px solid rgba(255,0,0,0.6)",
                }}
              />
        ...
        <p style={switchText}>
          ...
          <span style={linkText} onClick={() => navigate("/signup")}>
            Sign Up
          </span>
        </p>
      </motion.div>
